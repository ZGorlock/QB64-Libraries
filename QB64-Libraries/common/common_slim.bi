...
'******************************************************************************
'
'For a tutorial on how to get the most out of the features and functions of
'  this library, see the tutorial:
'https://db.tt/BNlUEi9V
'
'******************************************************************************
...
SUB SaveBMP (x1 AS INTEGER, y1 AS INTEGER, x2 AS INTEGER, y2 AS INTEGER, image AS LONG, filename AS STRING)
